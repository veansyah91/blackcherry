                ...
                <div class="card-header">
                    ...
                    <div class="row justify-between d-flex">
                        <div class="col-md-12 my-auto">
                            <strong id="header-form">Simpan Pengeluaran Bulanan</strong>
                        </div>
            ...
            <div class="card">
                ...
                <div class="alert alert-success d-none" role="alert" id="success-alert">
                    <div class="row justify-between">
                        <div class="col-8">
                            <Strong>Berhasil</Strong> <span id="status-alert"></span> Pengeluaran Bulanan.
                        </div>
...
@section('script')
    <script src="{{ asset('js/monthly-outcome/index.js') }}"></script>
@endsection